...
def worker(args):
    ...
    model = 4SC(_net_builder, args.num_classes, args.ema_m, args.p_cutoff, args.ulb_loss_ratio, args.hard_label,
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='4SC Training')

    '''
    Saving & loading of the model.
    '''
    parser.add_argument('--save_dir', type=str, default='./saved_models')
    parser.add_argument('-sn', '--save_name', type=str, default='4sc')
    ...
    parser.add_argument('--uratio', type=int, default=7, help='the ratio of unlabeled data to labeled data in each mini-batch')
